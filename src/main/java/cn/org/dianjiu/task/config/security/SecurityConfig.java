...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    private TUserServiceI adminService;
    @Autowired
...
//                .permitAll()
        ...
        httpSecurity.exceptionHandling()
                ...
                .authenticationEntryPoint(restAuthenticationEntryPoint); //未登陆
    }
    ...
    public UserDetailsService userDetailsService() {
        //获取登录用户信息
        return username -> {
            TUser user = adminService.getUserByUsername(username);
            if (user != null) {
                List<TRole> roleList = adminService.getRoleListByUserID(user.getId());
                //List<TMenu> menuList = adminService.getMenuListByUserID(user.getId());
